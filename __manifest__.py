...
#############################################################################
{
    ...
    'assets': {
        'web.assets_web': [
            'odoo_website_helpdesk/static/src/xml/**/*',
        ...
        'web.assets_frontend': [
            ('prepend', 'odoo_website_helpdesk/static/src/js/helpdesk_sale_error_guard.js'),
            'odoo_website_helpdesk/static/src/js/helpdesk_ticket_submit.js',
        ],
